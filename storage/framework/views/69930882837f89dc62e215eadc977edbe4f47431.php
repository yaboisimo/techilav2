...
<?php $__env->startSection('title', 'Techila.io'); ?>
<!-- Section 1 -->
    ...
    <div class="flex flex-col flex-wrap items-center justify-between py-6 mx-auto md:flex-row max-w-7xl">
        ...
        <div class="inline-flex flex-col items-center sm:flex-row sm:ml-5 lg:justify-end">
            <nav class="flex flex-wrap items-center space-x-4 text-xs font-semibold tracking-wide uppercase sm:space-x-6">
                <a href="#_" class="text-gray-500 hover:text-gray-500">Features</a>
                <a href="#_" class="text-gray-400 hover:text-gray-500">Pricing</a>
                <a href="#_" class="text-gray-400 hover:text-gray-500">Blog</a>
                <a href="#_" class="text-gray-400 hover:text-gray-500">About Us</a>
            </nav>
            <a href="#" class="inline-flex tracking-wide uppercase text-xs items-center sm:mt-0 mt-5 sm:ml-8 justify-center px-5 py-2.5 font-semibold text-white bg-pink-800 border border-transparent rounded-md shadow-sm hover:bg-pink-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-900">Create a Quiz</a>
        </div>
    </div>
</section>
...
<section class="w-full py-20 bg-white">
    <div class="flex flex-col items-center px-12 mx-auto max-w-7xl lg:flex-row">
        <div class="relative z-20 flex flex-col items-start justify-center w-full h-full lg:w-5/12">
            <p class="pb-5 text-sm font-medium tracking-wide text-pink-500 uppercase">Over 10,000 marketers are already using Techila</p>
            <h1 class="text-5xl font-bold xl:text-6xl pb-7 ">Create a quiz <br>in under 5 minutes</h1>
            <p class="text-lg text-gray-500 pb-7">Get registrations and learn more about your audience through your website and social media – all without the help of designers or programmers</p>
...
<section class="py-20 bg-white">
    <div class="flex flex-col px-8 mx-auto space-y-12 max-w-7xl xl:px-12">
        <div class="relative">
            <h2 class="w-full text-3xl font-bold text-center sm:text-4xl md:text-5xl"> What Is Quiz Marketing?            </h2>
            <p class="w-full py-8 mx-auto -mt-2 text-lg text-center text-gray-700 intro sm:max-w-3xl">A new way to capture responses from your audience from your website, social media and more. The essence is simple:</p>
        </div>
        <div class="flex flex-col mb-8 animated fadeIn sm:flex-row">
            ...
            <div class="flex flex-col justify-center mt-5 mb-8 md:mt-0 sm:w-1/2 md:w-7/12 sm:pr-16">
                <p class="mb-2 text-sm font-semibold leading-none text-left text-indigo-700 uppercase">Drag-n-drop design</p>
        ...
        <div class="flex flex-col mb-8 animated fadeIn sm:flex-row">
            ...
            <div class="flex flex-col justify-center mt-5 mb-8 md:mt-0 sm:w-1/2 md:w-7/12 sm:pl-16">
                <p class="mb-2 text-sm font-semibold leading-none text-left text-indigo-700 uppercase">know your data</p>
        ...
        <div class="flex flex-col mb-8 animated fadeIn sm:flex-row">
            ...
            <div class="flex flex-col justify-center mt-5 mb-8 md:mt-0 sm:w-1/2 md:w-7/12 sm:pr-16">
                <p class="mb-2 text-sm font-semibold leading-none text-left text-indigo-700 uppercase">Easy to customize</p>
...
<section class="relative px-10 py-16 overflow-hidden bg-gray-100">
    ...
    <div class="container relative z-10 px-4 mx-auto">
        <div class="w-full mb-8 sm:w-1/2 md:w-3/4 sm:pr-4 md:pr-12 sm:-mb-32 md:-mb-24 lg:-mb-36 xl:-mb-28">
            <h2 class="tracking-widest text-indigo-500 uppercase">See all templates</h2>
            <p class="my-3 text-5xl font-bold tracking-tighter text-indigo-900 lg:text-6xl">Get started with <br> ready-made templates</p>
    ...
    <div class="max-w-4xl py-20 mx-auto">
        ...
        <div class="grid gap-10 pt-16 pb-10 md:grid-cols-2">
            <div class="relative p-10 space-y-2 border border-gray-200 rounded-lg">
                ...
                <h3 class="text-2xl font-black">Easy to understand charts and graphs</h3>
                <p class="text-gray-700">Our application will help you make sense of all your data, we have a simple and easy to understand dashboard of charts and graphs.</p>
                <a href="#_" class="inline-block font-medium text-yellow-500 underline">Learn More</a>
            </div>
            <div class="relative p-10 space-y-2 border border-gray-200 rounded-lg">
                <svg class="w-10 h-10 text-yellow-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 4v12l-4-2-4 2V4M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                <h3 class="text-2xl font-black">Automatically bookmark your favorite settings</h3>
                <p class="text-gray-700">You can easily save your favorite settings and dashboards that you have built. You can also easily share them with others.</p>
                <a href="#_" class="inline-block font-medium text-yellow-500 underline">Learn More</a>
            </div>
            <div class="relative p-10 space-y-2 border border-gray-200 rounded-lg">
                <svg class="w-10 h-10 text-yellow-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z"></path></svg>
                <h3 class="text-2xl font-black">Split-test your pages to see which ones convert</h3>
                <p class="text-gray-700">Our system will also allow you to pick different variations of your pages to test and configure for maximum conversion.</p>
                <a href="#_" class="inline-block font-medium text-yellow-500 underline">Learn More</a>
            </div>
            <div class="relative p-10 space-y-2 border border-gray-200 rounded-lg">
                <svg class="w-10 h-10 text-yellow-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"></path></svg>
                <h3 class="text-2xl font-black">Lightning fast statically generated webpages</h3>
                <p class="text-gray-700">Each of the pages in our system are statically generated at build time. This means a faster website and better experience.</p>
                <a href="#_" class="inline-block font-medium text-yellow-500 underline">Learn More</a>
            </div>
            <div class="relative p-10 space-y-2 border border-gray-200 rounded-lg">
                ...
                <h3 class="text-2xl font-black">Simple and flexible scheduling system</h3>
                <p class="text-gray-700">Schedule your tasks easily and intuitively with our simple scheduling system. Giving you more time to focus on your business.</p>
                <a href="#_" class="inline-block font-medium text-yellow-500 underline">Learn More</a>
            </div>
            <div class="relative p-10 space-y-2 border border-gray-200 rounded-lg">
                <svg class="w-10 h-10 text-yellow-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 9l3 3-3 3m5 0h3M5 20h14a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                <h3 class="text-2xl font-black">Developer API to help you build the next great app</h3>
                <p class="text-gray-700">Our well documented developer API will allow you to build and extend functionality to take your app to the next level.</p>
                <a href="#_" class="inline-block font-medium text-yellow-500 underline">Learn More</a>
            </div>
        </div>
        <div class="w-full mt-10 mb-2 text-center">
            <a href="#_" class="mx-auto text-lg font-medium text-yellow-500 underline">All features</a>
        </div>
    </div>
</section>
...
<section class="py-20 bg-gray-50">
    <div class="max-w-6xl px-8 mx-auto lg:px-4">
        <div class="mb-16 text-center">
            <h2 class="max-w-lg mx-auto mb-4 text-5xl font-bold text-gray-700 font-heading">
                <span>Simple</span>
                <span class="relative pl-2 mr-2 text-indigo-700">
                  <span class="relative z-10">Pricing</span>
                  <span class="absolute bottom-0 left-0 w-full h-3 transform -skew-x-6 bg-indigo-200">

                  </span>
                </span>
                <span>Plans</span>
            </h2>
            <p class="max-w-2xl mx-auto text-lg text-gray-500">Pricing for businesses of all sizes. No commitment. Cancel Anytime.</p>
        </div>
        <div class="flex flex-wrap -mx-3">
            <div class="w-full px-3 mb-6 md:w-1/2 lg:w-1/3">
                <div class="px-8 pt-12 pb-8 text-center bg-white rounded-lg shadow">
                    <img class="h-24 mx-auto mb-8" src="https://cdn.devdojo.com/tails/icons/acorn.png" alt="starter plan image">
                    <h3 class="mb-4 text-5xl font-bold font-heading">Starter</h3>
                    <span class="flex items-center justify-center text-4xl font-bold text-gray-900 font-heading">$15<span class="ml-1 text-xs">/ mo</span></span>
                    <p class="mt-3 mb-8 text-sm text-gray-400">This plan is ideal for startups and small companies or organizations</p>
                    ...
                    <div>
                        <a href="#_" class="block px-6 py-5 mb-4 text-base font-semibold leading-none text-center text-white bg-indigo-700 rounded-lg sm:mb-0 hover:bg-indigo-800">Get Started</a>
                    </div>
                </div>
            </div>
            <div class="w-full px-3 mb-6 md:w-1/2 lg:w-1/3">
                <div class="px-8 pt-8 pb-8 text-center text-white transform scale-100 rounded-lg shadow-2xl lg:scale-105 bg-gradient-to-br from-indigo-600 via-indigo-600 to-purple-600">
                    <img class="h-24 mx-auto mb-8" src="https://cdn.devdojo.com/tails/icons/cube-b.png" alt="basic plan image">
                    <h3 class="mb-4 text-5xl font-bold font-heading">Basic</h3>
                    <span class="flex items-center justify-center text-4xl font-bold text-white font-heading">$25<span class="ml-1 text-xs">/ mo</span></span>
                    <p class="mt-4 mb-8 text-sm">This plan is ideal for small to medium sized businesses and organizations</p>
                    <div class="flex flex-col items-center mb-8">
                        <ul>
                    ...
                    <div>
                      <a href="#_" class="block px-6 py-5 mb-4 text-base font-semibold leading-none text-center text-indigo-700 rounded-lg bg-purple-50 hover:bg-white sm:mb-0 hover:text-indigo-800">Get Started</a>
                    </div>
                </div>
            </div>
            <div class="w-full px-3 mb-6 lg:w-1/3">
                <div class="px-8 pt-8 pb-8 text-center bg-white rounded-lg shadow">
                    <img class="h-24 mx-auto mb-8" src="https://cdn.devdojo.com/tails/icons/bucket-a.png" alt="plus plan image">
                    <h3 class="mb-4 text-5xl font-bold font-heading">Plus</h3>
                    <span class="flex items-center justify-center text-4xl font-bold text-gray-900 font-heading">$50<span class="ml-1 text-xs">/ mo</span></span>
                    <p class="mt-4 mb-8 text-sm text-gray-400">This plan is perfect for medium to larger sized companies and organizations</p>
                    <div class="flex flex-col items-center mb-8">
                        <ul class="text-gray-400">
                            <li class="flex mb-3">
                                <svg class="w-6 h-6 mr-2 text-green-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
<!-- Section 8 -->
<section class="py-8 border-t border-b border-indigo-200 bg-indigo-100">
    <div class="container mx-auto">
        <div class="flex flex-col items-center content-center justify-center text-center lg:flex-row lg:text-left">
            <img class="self-start w-auto h-24 px-4 mx-auto -mt-1 lg:mx-0" alt="Get Started" src="https://cdn.devdojo.com/images/december2020/coffee-start.png">

            <div class="flex flex-col content-center px-4 mx-4 my-6">
                <h4 class="pb-0 mb-0 text-lg font-semibold mb-md-0">Sign up today and try it out for free!</h4>
                <p class="mb-0 text-gray-700">Are you ready to increase traffic and sales? Try it free today</p>
            </div>
            <a href="#_" class="px-4 py-2 font-semibold text-white bg-indigo-700 border border-indigo-900 rounded shadow btn btn-secundary hover:bg-indigo-800">Get Started</a>
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\MSI\Desktop\techila\techila\resources\views/home.blade.php ENDPATH**/ ?>